...
*思路*：这个解法来自上一题的Discuss[key1]。假定我们一开始我们有一定的本钱，无论是买还是卖，我们都希望手上的钱剩余最多。用两个数组分别记录买和卖的时候手上剩余的钱。动态规划的构建：我们假定在第i次“买”的时候，我们已近获得了第i-1次“卖”后剩余的最多钱；在第i次“卖”的时候，我们已近获得了第i次“买”后剩余的最多钱。
